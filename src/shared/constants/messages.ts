...
export const COMMON_MESSAGES = {
  VALIDATION: {
    ...
    SESSION_ID_REQUIRED: ENTITY_MESSAGES.ID_REQUIRED('сессии'),
    USER_ID_INVALID: ENTITY_MESSAGES.ID_INVALID('пользователя'),
    COURSE_ID_INVALID: ENTITY_MESSAGES.ID_INVALID('курса'),
    LESSON_ID_INVALID: ENTITY_MESSAGES.ID_INVALID('урока'),
    SESSION_ID_INVALID: ENTITY_MESSAGES.ID_INVALID('сессии'),
